...
public class ResultProvider extends ContentProvider {
    ...
    // result.team_id = ?
    private static final String teamSelection = ResultContract.ResultEntry.TABLE_NAME_RESULTADOS; // + "." + ResultContract.ResultEntry.COLUMN_TEAM_ID + "= ? ";
    private static final String noticiaSelection = ResultContract.ResultEntry.TABLE_NAME_NOTICIAS;
    private static final String equipoSelection = ResultContract.ResultEntry.TABLE_NAME_EQUIPO;
    ...
    */
    ...
    private void normalizeDate(ContentValues values) {
        ...
        if (values.containsKey(ResultContract.ResultEntry.COLUMN_FECHA)) {
            long dateValue = values.getAsLong(ResultContract.ResultEntry.COLUMN_FECHA);
