...
public class MainActivity extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent = new Intent(this, QuirquinchoSantoService.class);

        intent.putExtra(QuirquinchoSantoService.TEAM_QUERY_EXTRA, Integer.toString(Utility.getPreferedTeam(this)));
    ...
    public void onSectionAttached(int number) {
        switch (number) {
            case 1:
                mTitle = getString(R.string.title_competiciones);
                break;
            case 2:

                mTitle = getString(R.string.title_equipo);
                getSupportFragmentManager().beginTransaction().replace(R.id.container,new EquipoFragment()).commit();
                break;
            case 3:
                mTitle = getString(R.string.title_resultados);
            ...
            case 4:
                ...
                //getSupportFragmentManager().beginTransaction()
                  //      .add(R.id.container, new NoticiasFragment(), RESULT_FRAGMENT_TAG)
                    //    .commit();
                break;
        }
    }
